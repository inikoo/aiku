...
return new class () extends Migration {
    public function up(): void
    {
        Schema::create('country_language', function (Blueprint $table) {
            ...
            $table->foreign('country_id')->references('id')->on('public.countries')->onDelete('cascade');
            $table->foreign('language_id')->references('id')->on('public.languages')->onDelete('cascade');
        });
        ...
        Schema::create('country_timezone', function (Blueprint $table) {
            ...
            $table->foreign('country_id')->references('id')->on('public.countries')->onDelete('cascade');
            $table->foreign('timezone_id')->references('id')->on('public.timezones')->onDelete('cascade');
        });
