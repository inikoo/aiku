...
import ShopifyFooter from "@/Layouts/Shopify/ShopifyFooter.vue"
import ShopifyLeftSideBar from "@/Layouts/Shopify/ShopifyLeftSideBar.vue"
import ShopifyRightSideBar from "@/Layouts/Shopify/ShopifyRightSideBar.vue"
import ShopifyTopBar from "@/Layouts/Shopify/ShopifyTopBar.vue"
import Breadcrumbs from "@/Components/Navigation/Breadcrumbs.vue"
import { library } from "@fortawesome/fontawesome-svg-core"
import { initialiseShopifyApp } from "@/Composables/initialiseShopifyApp"
import { useLayoutStore } from "@/Stores/shopifyLayout"
...
<template>
    ...
    <div class="isolate relative min-h-full transition-all"
        ...
        <ShopifyTopBar @sidebarOpen="(value: boolean) => sidebarOpen = value" :sidebarOpen="sidebarOpen"
            logoRoute="shopify.dashboard.show" urlPrefix="shopify." />
        ...
        <div class="">
            ...
            <ShopifyLeftSideBar class="-left-2/3 transition-all z-20 block md:left-[0]"
        ...
        <!-- Sidebar: Right -->
        <ShopifyRightSideBar class="fixed top-16 w-44 transition-all"
