<template>
	<div class="flex flex-1 items-center justify-between lg:justify-start">
		...
		<div class="flex center-content">
			<div class="text-sm lg:text-base flex items-center divide-x divide-gray-100  space-x-12 ">
				<Link
					...
					class="group flex justify-end items-center cursor-pointer py-1  space-x-12 px-4 md:px-4 lg:px-2"
			...
			<!-- Right Menu -->
			<div
				class="text-sm lg:text-base text-gray-600 inline-flex place-self-center rounded-r justify-center border-solid  space-x-12"
			...
			>
				...
				<Link
					...
					class="group flex justify-center items-center cursor-pointer py-1 space-x-12 px-4"
