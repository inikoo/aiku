        ...
        <Disclosure as="nav" class="bg-gray-100" v-slot="{ open }">
            <div class=" px-0">
                ...
                <div class="flex h-12 lg:h-10 flex-shrink-0 border-b border-gray-200 bg-white ">
                    ...
                    <div class="flex flex-1 justify-between pl-3 md:pl-0">
                        ...
                        <div class="flex items-center">
                            ...
                            <Menu as="div" class="relative ml-3 mr-6 hidden lg:block ">
                                <div>
                                    <MenuButton class="flex max-w-xs items-center rounded-full bg-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                    ...
                    <button type="button" class="border-l border-gray-400 px-4 text-gray-900 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-cyan-500 lg:hidden" @click="sidebarOpen = true">
                ...
                <div class="border-t border-gray-700 pt-4 pb-3">
                    ...
                    <div class="mt-3 space-y-1 px-2">
                        <DisclosureButton v-for="item in userNavigation" :key="item.name" as="a" :href="item.href"
                                          class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">{{ item.name }}
                        </DisclosureButton>
                    </div>
                </div>
            </DisclosurePanel>
