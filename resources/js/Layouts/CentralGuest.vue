            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6">
                <div class="flex justify-between items-center py-6 md:justify-start md:space-x-10">
                    ...
                    <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                        ...
                        <Link v-if="$page.props.auth.user" :href="route('central.dashboard')" class="text-sm text-gray-700 underline">
                            {{$t('Dashboard')}}
                        </Link>

                        <template v-else>
                            <Link :href="route('central.register')" class="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900">
                                {{$t('Register')}}
                            </Link>

                            <Link :href="route('central.login')" class="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700">
                                {{$t('Log in')}}
                            </Link>
                        </template>
                    </div>
                    ...
                    <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
                      ...
                      {{ item.name }}
                        ...
                        <div class="py-6 px-5 space-y-6">
                            ...
                            <div>
                                <Link :href="route('central.login')" class="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700"> {{$t('Log in')}} </Link>
                                <p class="mt-6 text-center text-base font-medium text-gray-500">
                                    New user?
                                    <Link :href="route('central.register')" class="text-indigo-600 hover:text-indigo-500"> Register </Link>
                                </p>
                            </div>
                        </div>
                    </div>
