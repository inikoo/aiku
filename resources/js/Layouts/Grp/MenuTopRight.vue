    ...
    <div class="flex justify-between gap-x-2">
        <div class="flex items-center gap-x-0 sm:gap-x-4 sm:divide-x divide-gray-200">
            ...
            <button v-if="isAskBotEnabled === 'true'" @click="showAskBot = !showAskBot" id="ask-bot"
                ...
                <div class="hidden whitespace-nowrap md:flex items-center justify-end text-gray-500/80 tracking-tight space-x-1">
                    <span v-if="isUserMac" class="ring-1 ring-gray-300 bg-white px-2 leading-none text-xl rounded">⌘</span>
                    <span v-else class="ring-1 ring-gray-300 bg-white px-2 py-0.5 text-xs rounded">Ctrl</span>
                    <span class="ring-1 ring-gray-300 bg-white px-2 py-0.5 text-xs rounded">Shift</span>
                    <span class="ring-1 ring-gray-300 bg-white px-1.5 py-0.5 text-xs rounded">K</span>
                </div>
