        ...
        <div class="container mx-auto flex flex-col justify-between items-center py-4 px-6">
            <div class="w-full grid grid-cols-3 items-center gap-6">
                ...
                <div :style="getStyles(modelValue.logo.properties)">
                    ...
                    <Image v-else :src="modelValue?.logo?.src" :style="{ width: `${modelValue.logo.width}%` }"></Image>
                </div>
                ...
                <div class="justify-self-end w-fit">
                    <button :style="getStyles(modelValue.gold_member.properties)"
                        ...
                        v-if="loginMode">
                        <Editor v-model="modelValue.gold_member.text" :editable="false" />
                    </button>
                </div>
