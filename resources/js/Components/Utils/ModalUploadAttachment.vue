            ...
            <div>
                ...
                <div class="grid gap-x-3 px-1">
                    <div class="mb-2 card flex justify-end">
                        <Select v-model="selectedType" :options="typeEmployee" optionLabel="name"
                            placeholder="Select a type" class="w-full md:w-40">
                    ...
                    <div @drop="(e: any) => (e.preventDefault(), onUploadFile(e.dataTransfer.files[0]))"
                        ...
                        <div v-else-if="!isLoadingUpload" class="">
                            ...
                            <div v-if="!isDraggedFile" class="text-center text-gray-500">
                                ...
                                <div class="flex w-fit mx-auto text-xs leading-6 ">
                                    <p class="">{{ trans("Drag and drop, or browse your files") }}
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <Transition name="headlessui">
                        <div v-if="selectedFile" class="text-xxs mt-3 max-w-3xl overflow-x-hidden">
                            ...
                            <div class="flex justify-end mt-3">
                                <Button @click="() => submitUpload()" label="Submit" size="s" full
