                        ...
                        <tr v-for="(component, index) in fieldData.options" :key="index">
                            ...
                            <td class="whitespace-nowrap px-3 py-1.5 text-sm text-gray-500 text-center">
                                <input v-model="form[fieldName][index].show" :id="component.label + index" type="checkbox"
                                    class="w-4 h-4 text-indigo-600 bg-gray-100 border-gray-300 rounded cursor-pointer focus:ring-indigo-500 focus:ring-1">
                            </td>
                            <td class="whitespace-nowrap px-3 py-1.5 text-sm text-gray-500 text-center">
                                <input v-model="form[fieldName][index].required" :id="component.label + index" type="checkbox"
                                    class="w-4 h-4 text-indigo-600 bg-gray-100 border-gray-300 rounded cursor-pointer focus:ring-indigo-500 focus:ring-1">
                            </td>
                        </tr>
                    </tbody>
