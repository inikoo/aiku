...
const activeImageIndexModal = ref<string | null>(null)
...
// New helper method to open the gallery modal
function openGallery(column: string) {
	activeImageIndexModal.value = column
	isModalGallery.value = true
}
</script>
				...
				<div class="relative lg:row-span-2">
					...
					<div
						...
						<div
							...
							<div
								v-if="!modelValue.column1.source"
