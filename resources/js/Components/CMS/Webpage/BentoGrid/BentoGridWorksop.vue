...
<template>
		...
		<div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
			...
			<div class="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
				<div class="relative lg:row-span-2">
					...
					<div
						...
						<div
							...
							<div v-if="!modelValue.column1.source
							...
							<div v-else class="absolute">
								...
								<Image :src="modelValue.column1.source" class="w-full h-full object-cover rounded-lg" />
							</div>
						</div>
					</div>
					<div
				...
				<div class="relative max-lg:row-start-1">
					...
					<div
						...
						<div
							...
							<div v-if="!modelValue.column2.source" class="relative w-full max-lg:max-w-xs">
								<img class="w-full object-cover rounded-lg shadow-lg"
							...
							<div v-else class="relative w-full max-lg:max-w-xs">
								...
								<Image :src="modelValue.column2.source"
				...
				<div class="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
					...
					<div
						class=" flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)]">
						<!-- Text Editor Section -->
						<div class="px-8 pt-8 sm:px-10 sm:pt-10">
						...
						<div class="flex flex-1 items-center justify-center px-8 max-lg:py-6 lg:pb-2">
							...
							<div v-if="!modelValue.column3.source" class="relative w-full max-lg:max-w-xs">
								<img class="h-[min(152px,40cqw)] object-cover object-center rounded-lg shadow-lg"
							...
							<div v-else class="relative w-full max-lg:max-w-xs">
								...
								<Image :src="modelValue.column3.source"
				...
				<div class="relative lg:row-span-2">
					...
					<div
						...
						<div
							...
							<div v-if="!modelValue.column4.source"
								class="absolute inset-x-10 bottom-0 top-10 overflow-hidden rounded-t-[12cqw] border-x-[3cqw] border-t-[3cqw] border-gray-700 bg-gray-900 shadow-2xl">
								<img class="size-full object-cover object-top"
									src="https://tailwindui.com/plus/img/component-images/bento-03-mobile-friendly.png"
							...
							<div v-else class="absolute ">
								...
								<Image :src="modelValue.column4.source" class="size-full object-cover object-top" />
							</div>
						</div>
					</div>
	...
	<Modal :isOpen="isModalGallery" @onClose="() => (isModalGallery = false)" width="w-3/4">
		<GalleryManagement :maxSelected="1" :uploadRoute="{
			...webpageData.images_upload_route,
			parameters: id,
		}" :closePopup="() => (isModalGallery = false)" @submitSelectedImages="onChangeImage" />
	</Modal>
</template>
