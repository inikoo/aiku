...
<template>
	<div 
		...
		<!-- Section: Currency -->
		<div v-show="isSectionVisible" class="flex flex-wrap justify-between items-center gap-4 lg:gap-8">
		...
		<!-- Navigation Tabs -->
		<nav class="isolate flex flex-1 rounded-full bg-white border border-gray-200 p-1 hidden sm:flex" aria-label="Tabs">
		...
		<FontAwesomeIcon 
			...
			class="ml-4 text-2xl text-indigo-500 cursor-pointer hover:text-indigo-600 transition"
		/>
	</div>
