...
import { faEllipsisV, faStar } from '@fal'
...
import { ref } from 'vue'
library.add(faEllipsisV, faStar, faCircle, faChrome, faGoogle, faTimes, faRedoAlt, faArrowLeft, faArrowRight, faPlus, faPuzzlePiece, fasStar)    
...
<template>
    <div class="w-full max-w-4xl mx-auto mt-4 rounded-2xl overflow-hidden shadow-xl">
        <div class="bg-gray-200 pt-1 flex">
            ...
            <div class="w-full max-w-64 bg-white rounded-t-lg px-3 flex justify-between items-center">
                <div class="flex gap-x-2 items-center ">
                    <FontAwesomeIcon icon='fab fa-chrome' class='' fixed-width aria-hidden='true' />
                    <div>New Tab</div>
                </div>
                <div class="h-5 w-5 flex items-center rounded-full hover:bg-gray-200 cursor-pointer">
                    <FontAwesomeIcon icon='far fa-times' class='text-gray-500' fixed-width aria-hidden='true' />
                </div>
            </div>

            <div class="bg-white">
                <div class="bg-gray-200 h-full rounded-bl-lg flex items-center px-2 py-1">
                    <div class="h-full px-2 flex items-center rounded-md hover:bg-black/10 cursor-pointer">
            ...
            <div class="px-3 py-1 text-sm bg-gray-100 rounded-full w-full flex items-center justify-between">
                <div class="flex items-center gap-x-2">
                    <div class="rounded-full bg-gray-300 h-5 w-5 flex justify-center items-center">
                        <FontAwesomeIcon icon='fab fa-google' class='text-xs' fixed-width aria-hidden='true' />
                    </div>
                    <div class="font-medium">www.website.com<span class="font-normal text-gray-400">/navigation/hello/world</span></div>
                </div>
        ...
        <div class="bg-indigo-500 w-full h-auto aspect-[16/9] overflow-hidden">
            <slot name="page" />
        </div>
    </div>
</template>