...
import { cloneDeep } from "lodash";
  ...
  <template>
      <PureInput v-model="pallet.form[fieldName]" @blur="(value) => { if (value) emits('onSave', pallet, fieldName) }"
          @onEnter="(value) => { if (value) emits('onSave', pallet, fieldName) }" :suffix="true">
          <template #suffix>
