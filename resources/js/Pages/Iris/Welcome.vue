...
const contentImages = [
    ...
    },
    {
        ...
        description: `Our pick and pack service delivers speed and precision, ensuring flawless order fulfillment uk. From warehouse to your customer's doorstep without errors and delays.`
    },
    {
        label: 'Rework & Repack',
