<template>
    ...
    <div class="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <img class="mx-auto h-12 w-auto" src="art/logo.png" alt="Workflow" />
            </Link>
            ...
            <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                ...
                <form class="space-y-6" @submit.prevent="submit">
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm">
                            <Password  id="password" name="password" v-model="form.password" showPassword="true"  />
                        </div>
                    </div>
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-6 grid grid-cols-3 gap-3">
                        ...
                        <div>
                            <a href="#" class="relative w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
                                <span class="sr-only">Sign in with GitHub</span>
                                <svg class="w-5 h-5  relative bottom-px"  aria-hidden="true" fill="currentColor"
                                     width="24" height="24"
                                     viewBox="0 0 24 24"
