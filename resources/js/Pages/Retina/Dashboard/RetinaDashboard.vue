...
<template>
  ...
  <div v-if="customer?.status == 'pending_approval'" class="grid grid-cols-3 gap-6 p-6">
    ...
    <div class="col-span-3 bg-green-50 rounded-lg shadow-xl overflow-hidden border border-green-300 p-6">
      <h4 class="text-lg font-semibold text-green-800">Thank you for applying!</h4>
      <p class="mt-2 text-sm text-green-700">Your application is under review. Please wait for further information from us.</p>
    </div>
    ...
    <div
      ...
      <div class="px-6 py-4 border-b border-gray-200">
        ...
        <p class="mt-1 text-sm text-gray-500">Company and contact information.</p>
      </div>
    ...
    <div class="rounded-lg shadow-2xl overflow-hidden border border-[#0F1626] h-fit">
      ...
      <div class="p-6 bg-white">
        ...
        <div class="mb-6">
          <h4 class="text-sm font-medium text-gray-500">Office Address</h4>
