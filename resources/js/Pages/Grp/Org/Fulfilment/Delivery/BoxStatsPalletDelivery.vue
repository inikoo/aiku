                ...
                <dl class="mt-2 space-y-2 text-gray-600">
                    ...
                    <div class="flex flex-col justify-center gap-y-2 border-t border-gray-200 pt-2">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <dd :class="boxStats.order_summary.tax.fee ? '' : 'text-green-600 animate-pulse'" class="text-sm">{{ boxStats.order_summary.tax.fee ? locale.currencyFormat(boxStats.order_summary.currency_code, boxStats.order_summary.tax.fee) : 'Free' }}</dd>
                            <!-- <dd class="text-sm">{{ locale.currencyFormat(boxStats.order_summary.currency_code, boxStats.order_summary.tax.fee) }}</dd> -->
                        </div>
                    </div>

                    <div class="flex items-center justify-between border-t border-gray-200 pt-3">
                        <dt class="text-base font-medium">{{ trans('Order total') }}</dt>
                        <dd class="text-base font-medium">{{ locale.currencyFormat(boxStats.order_summary.currency_code, boxStats.order_summary?.total_price || 0) }}</dd>
                    </div>
                </dl>
