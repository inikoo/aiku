...
library.add(faTriangle, faChevronDown, faSeedling, faTimesCircle, faFolderOpen)
	...
	<div class="px-4 sm:px-6 lg:px-8">
		...
		<div class="mt-4 block">
			<nav class="isolate flex rounded border-b border-gray-300" aria-label="Tabs">
				<div
					v-for="(interval, idxInterval) in abcdef"
					:key="idxInterval"
								...
								<div
									...
									{{
										data.interval_percentages?.sales[selectedDateOption]
											?.percentage
											? `(${data.interval_percentages.sales[selectedDateOption].percentage}%)`
											: ""
									}}
