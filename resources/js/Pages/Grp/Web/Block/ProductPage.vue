...
<template>
    ...
    <div type="button" v-if="modelValue.emptyState"
        ...
        <div class="flex justify-center m-2">
            <PureInput v-model="modelValue.product" :placeholder="'Banner Link'" @onEnter="(e) => onEnter(e)">
            </PureInput>
    ...
    <div v-else id="app" class="mx-auto max-w-5xl text-gray-600">
        ...
        <div class="grid grid-cols-5 gap-x-10 mb-12">
            ...
            <div class="col-span-2">
                ...
                <div class="mb-4">
                    <div class="flex items-center gap-x-4 border-t border-gray-300 pl-3 font-bold text-gray-600 py-1">
                        Buy Now Pay Later
                        <img src="https://pastpay.com/wp-content/uploads/2023/07/PastPay-logo-dark-edge.png" class="h-3"
                            alt="">
                        <i class="fas fa-chevron-right text-sm text-gray-500"></i>
                    </div>
                    <div class="flex items-center gap-x-4 border-t border-gray-400 pl-3 font-bold text-gray-600 py-1">
                        Delivery Info
                        <i class="fas fa-chevron-right text-sm text-gray-500"></i>
                    </div>
                    <div class="flex items-center gap-x-4 border-t border-gray-400 pl-3 font-bold text-gray-600 py-1">
        ...
        <div>
            ...
            <div class="grid grid-cols-4 gap-x-10">
                ...
                <div class="relative">
                    <i class="absolute top-2 right-2 text-2xl far fa-heart text-gray-500"></i>
                    <img src="https://tailwindui.com/img/ecommerce-images/product-page-03-related-product-01.jpg" alt=""
                        class="">
                    <div class="mb-0.5 font-bold leading-5">
                        8x Monkey Bath Bomb 90g - Guava & Strawberry
                    </div>
                ...
                <div class="relative">
                    <i class="absolute top-2 right-2 text-2xl far fa-heart text-gray-500"></i>
                    <img src="https://tailwindui.com/img/ecommerce-images/product-page-03-related-product-03.jpg" alt=""
                        class="">
                    <div class="mb-0.5 font-bold leading-5">
                        8x Monkey Bath Bomb 90g - Guava & Strawberry
                    </div>
