...
<template>
    <div class="container max-w-7xl mx-auto shadow-xl">
        <RenderHeaderMenu v-if="header" :data="layout.header" :menu="layout?.navigation"
        ...
        <component v-if="footer" :is="getComponentFooter(layout.footer.code)" v-model="layout.footer.data.footer"
