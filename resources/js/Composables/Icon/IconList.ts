 ...
 * Created on: 19-09-2024, Bali, Indonesia
...
export const IconList = {
    ...
    'finalised': "fal fa-tasks",
    'cancelled': "fal fa-times-circle",


    'manufactured': "fal fa-industry",
    'processing': "fal fa-cogs",
    'settled': "fal fa-check-double",

    'in_queue': "fal fa-hourglass-half",
    'picker_assigned': "fal fa-user-check",

    'on-hold': 'fal fa-pause-circle',
    'assigned': 'fal fa-user-check',
    'queried': 'fal fa-question-circle',
    'waiting': 'fal fa-hourglass-half',

    'done': 'fal fa-flag-checkered'
}