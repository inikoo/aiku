...
class RemoveMarketplaceSupplier extends InertiaAction
{
    ...
    public function getAction($route): array
    {
        return  [
            ...
            'title'       => __('Delete Marketplace Suppliers'),
            'text'        => __("This action will delete this supplier and all it's products"),
            'route'       => $route
        ];
    }

    public function htmlResponse(Agent $supplier, ActionRequest $request): Response
    {
