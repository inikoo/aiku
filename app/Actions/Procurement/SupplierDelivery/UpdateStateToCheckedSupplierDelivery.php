...
class UpdateStateToCheckedSupplierDelivery
{
    ...
    {
        $data = [
            'state' => SupplierDeliveryStateEnum::CHECKED,
        ];

        if (in_array($supplierDelivery->state, [SupplierDeliveryStateEnum::RECEIVED, SupplierDeliveryStateEnum::SETTLED])) {
