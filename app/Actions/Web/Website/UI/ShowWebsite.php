        ...
        return Inertia::render(
            ...
            [
                ...
                WebsiteTabsEnum::ANALYTICS->value => $this->tab == WebsiteTabsEnum::ANALYTICS->value ?
                    fn () => GetWebsiteCloudflareAnalytics::make()->action($website, $request->only(['since', 'until', 'showTopNs', 'partialShowTopNs']))
                    : Inertia::lazy(fn () => GetWebsiteCloudflareAnalytics::make()->action($website, $request->only(['since', 'until', 'showTopNs', 'partialShowTopNs'])))
            ]
        )->table(
