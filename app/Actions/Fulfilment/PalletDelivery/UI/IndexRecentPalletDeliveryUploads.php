...
class IndexRecentPalletDeliveryUploads extends OrgAction
{
    ...
    {
        $upload = Upload::where('parent_id', $palletDelivery->id)->where('parent_type', $palletDelivery->getMorphClass());
        // where data > last 24 hrs
    ...
    public function asController(PalletDelivery $palletDelivery, ActionRequest $request): array|Collection
    {
        ...
        return $this->handle( $palletDelivery,  $request->user()->id);
