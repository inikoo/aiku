...
class IndexPalletsFromDelivery extends OrgAction
{
    ...
    public function handle(PalletDelivery $parent, $prefix = null): LengthAwarePaginator
    {
        ...
        $query = QueryBuilder::for(Pallet::class)
            ->whereHas('palletDeliveries', function ($query) use ($parent) {
    ...
    public function tableStructure(PalletDelivery $parent, $prefix = null, $modelOperations = []): Closure
    {
