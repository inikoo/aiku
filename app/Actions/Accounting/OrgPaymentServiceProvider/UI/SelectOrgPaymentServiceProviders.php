...
*/
        ...
        */
        ...
        return $queryBuilder
            ...
            ->select(['org_payment_service_providers.slug','payment_service_providers.code', 'org_payment_service_providers.code as org_code', 'org_payment_service_providers.slug as org_slug', 'org_payment_service_providers.organisation_id as org_id', 'org_payment_service_provider_stats.number_payment_accounts', 'org_payment_service_provider_stats.number_payments','name', 'payment_service_providers.id'])
            ->leftJoin(
