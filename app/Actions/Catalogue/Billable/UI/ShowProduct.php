...
class ShowProduct extends OrgAction
{
    ...
    public function inFulfilment(Organisation $organisation, Fulfilment $fulfilment, Billable $product, ActionRequest $request): Billable
    {
    ...
    {
        $headCrumb = function (Billable $product, array $routeParameters, $suffix) {
            return [
        ...
        $product=Billable::where('slug', $routeParameters['product'])->first();
