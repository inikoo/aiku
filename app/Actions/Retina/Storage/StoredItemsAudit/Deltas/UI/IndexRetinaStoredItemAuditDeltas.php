...
namespace App\Actions\Retina\Storage\StoredItemsAudit\Deltas\UI;
...
class IndexRetinaStoredItemAuditDeltas extends RetinaAction
{
    ...
    public function tableStructure(StoredItemAudit $storedItemAudit, $prefix = null, $modelOperations = []): Closure
    {
