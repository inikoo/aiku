...
class ShowGroupDashboard extends OrgAction
{
    ...
    public function getDashboardInterval(Group $group, array $userSettings): array
    {
        ...
        if ($this->tabDashboardInterval == DashboardIntervalTabsEnum::SALES->value) {
            ...
            $dashboard['table'][0]['data'] = Inertia::lazy(function () use ($organisations, $selectedInterval, $group, &$dashboard, $selectedCurrency, &$visualData, &$total) {
            ...
            $dashboard['table'][1]['data'] = Inertia::lazy(function () use ($shops, $selectedInterval, $group, &$dashboard, $selectedCurrency, &$visualData, &$total) {
