...
class ShowLocation extends OrgAction
{
                        ...
                        $this->canDelete ?
                            match ($request->route()->getName()) {
                                ...
                                'grp.org.warehouses.show.inventory.locations.show' => [
                                    ...
                                    'style' => 'delete',
                                    'route' => [
                                        'name'       => 'grp.org.warehouses.show.inventory.locations.remove',
                                        'parameters' => $request->route()->originalParameters()
                                    ],
                                ],
                                'grp.org.warehouses.show.inventory.warehouse-areas.show.locations.show' => [
                                    ...
                                    'style' => 'delete',
                                    'route' => [
                                        'name'       => 'grp.org.warehouses.show.inventory.warehouse-areas.show.locations.remove',
                                        'parameters' => $request->route()->originalParameters()
                                    ]
                                ]
                            } : false
    ...
    public function getBreadcrumbs(string $routeName, array $routeParameters, string $suffix = ''): array
    {
        ...
        return match ($routeName) {
            ...
            'grp.org.warehouses.show.inventory.locations.show' => array_merge(
                ...
                $headCrumb(
                    ...
                    [
                        ...
                        'model' => [
                            'name'       => 'grp.org.warehouses.show.inventory.locations.show',
                            'parameters' => [
                                $routeParameters['organisation']->slug,
                                $routeParameters['warehouse']->slug,
                                $routeParameters['location']->slug
            ...
            'grp.org.warehouses.show.inventory.warehouse-areas.show.locations.show' => array_merge(
                (new ShowWarehouseArea())->getBreadcrumbs(
                ...
                $headCrumb(
                    ...
                    [
                        'index' => [
                            'name'       => 'grp.org.warehouses.show.inventory.warehouse-areas.show.locations.index',
                            'parameters' => [
                                $routeParameters['warehouse']->slug,
                                $routeParameters['warehouseArea']->slug,
                            ]
                        ...
                        'model' => [
                            'name'       => 'grp.org.warehouses.show.inventory.warehouse-areas.show.locations.show',
                            'parameters' => [
                                $routeParameters['warehouse']->slug,
                                $routeParameters['warehouseArea']->slug,
                                $routeParameters['location']->slug
    ...
    public function getPrevious(Location $location, ActionRequest $request): ?array
    {
        $previous=Location::where('slug', '<', $location->slug)->when(true, function ($query) use ($location, $request) {
            switch ($request->route()->getName()) {
                case 'grp.org.warehouses.show.inventory.locations.show':
