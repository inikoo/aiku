...
class StoreOrgStockMovement extends OrgAction
{
    public function handle(OrgStock $orgStock, Location $location, array $modelData): OrgStockMovement
    {
        ...
        data_set($modelData, 'sales_grp_currency', Arr::get($modelData, 'amount') * GetCurrencyExchange::run($orgStock->organisation->currency, $orgStock->group->currency), overwrite: false);
