...
use Database\Factories\Accounting\PaymentServiceProviderFactory;
use Eloquent;
 ...
 * @property-read Collection<int, PaymentAccount> $accounts
 * @property-read Collection<int, Payment> $payments
 * @property-read PaymentServiceProviderStats|null $stats
 * @method static PaymentServiceProviderFactory factory($count = null, $state = [])
