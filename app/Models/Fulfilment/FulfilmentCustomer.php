 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Fulfilment\StoredItemAudit> $storedItemAudit
...
class FulfilmentCustomer extends Model
{
    ...
    public function storedItemAudit(): HasMany
    {
