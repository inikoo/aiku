 ...
 * @property int|null $number_email_bulk_runs
 * @property int|null $number_email_bulk_runs_state_scheduled
 * @property int|null $number_email_bulk_runs_state_sending
 * @property int|null $number_email_bulk_runs_state_sent
 * @property int|null $number_email_bulk_runs_state_cancelled
 * @property int|null $number_email_bulk_runs_state_stopped
