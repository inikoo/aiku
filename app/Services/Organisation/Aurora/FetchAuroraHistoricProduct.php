...
use App\Actions\SourceUpserts\Aurora\Single\UpsertProductFromSource;
...
class FetchAuroraHistoricProduct extends FetchAurora
{
    ...
    {
        $this->parsedData['product'] = UpsertProductFromSource::run($this->organisationSource, $this->auroraModelData->{'Product ID'});


        $deleted_at = $this->auroraModelData->{'Product History Valid To'};
        ...
        $this->parsedData['historic_product'] = [
            ...
            'created_at' => $this->auroraModelData->{'Product History Valid From'},
            'deleted_at' => $deleted_at,
            'organisation_source_id'  => $this->auroraModelData->{'Product Key'}
        ];
    }
