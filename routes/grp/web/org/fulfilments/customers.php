...
use App\Actions\Fulfilment\FulfilmentCustomer\UI\IndexRejectedFulfilmentCustomers;
...
Route::get('rejected', IndexRejectedFulfilmentCustomers::class)->name('rejected.index');
